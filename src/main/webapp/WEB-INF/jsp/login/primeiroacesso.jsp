...
<body>
	...
	<div class="form-area">
		...
		<br>
		<form class="form-horizontal" action="${linkTo[LoginController].salvar()}" method="post">
			...
			<div class="form-group">	
				...
				<div class="col-sm-6">
					<input class="form-control" type="text" name="usuario.email" value="${usuario.email}"required="required"  placeholder="Email@exemplo.com"/>
				</div>
			</div>
			<div class="form-group">	
			...
			<br>
			<a type="button" class="col-sm-offset-2 btn btn-default" href="${linkTo[IndexController].index()}">Cancelar</a>
